...
export const metadata: Metadata = {
  title: "Whack-a-Mole | NewHopeGGN",
  description: "Play the NewHopeGGN weekly Whack-a-Mole minigame. Hit moles to win Once Human weapons — legendary, epic, rare and more. One chance per week.",
  keywords: ["minigame", "whack a mole", "Once Human", "prizes", "weapons", "NewHopeGGN", "weekly"],
  openGraph: {
    title: "Whack-a-Mole | NewHopeGGN",
