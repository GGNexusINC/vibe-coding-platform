    ...
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      {!hideChrome && (() => {
        ...
        return (
          <header className={`sticky top-0 z-40 border-b bg-background/80 backdrop-blur-2xl transition-colors ${
            ...
            />
            <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 px-4 lg:px-8 py-2.5">
      ...
      <main className="relative flex-1 overflow-hidden">
            ...
            <video
              ...
              style={{
                objectPosition:
                  ...
                  pathname.startsWith("/rules") ? "10% 10%" :
                  pathname.startsWith("/lottery") ? "10% 90%" :
                  pathname.startsWith("/support") ? "95% 95%" :
                  pathname.startsWith("/dashboard") ? "25% 25%" :
        ...
        <div className="rz-starfield pointer-events-none">
          ...
          <span className="rz-shooting-star" style={{ top: "16%", left: "-26%", animationDelay: "0.2s" }} />
          <span className="rz-shooting-star" style={{ top: "52%", left: "-30%", animationDelay: "2s" }} />
        </div>
        ...
        <footer className="border-t border-line bg-background/80 backdrop-blur-xl">
          <div className="mx-auto w-full max-w-6xl px-4 py-12">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between mb-10">
              <div className="max-w-xs">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-bold text-orange-100 tracking-wide">
                    NewHope<span className="text-lime-400">GGN</span>
                  </span>
                </div>
                <p className="text-xs text-stone-500 leading-relaxed">
                  Once Human community server — wipe packs, VIP perks, live Discord feed, and fast staff support.
                </p>
                <a
                  href="https://discord.gg/hopeggn"
                  target="_blank"
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={l.href}>
                        <Link href={l.href} className="text-stone-400 hover:text-orange-200 transition">
                          {l.label}
                        </Link>
                      </li>
                    ))}
            ...
            <div className="border-t border-white/5 pt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between text-xs text-stone-600">
              <span>
                © {new Date().getFullYear()} NewHope<span className="text-lime-400">GGN</span> — Once Human Community Server
              </span>
              <Link
                href="/lottery"
                className="inline-flex h-8 items-center gap-1.5 rounded-full border border-lime-400/30 bg-lime-400/10 px-4 text-xs font-bold text-lime-100 transition hover:scale-[1.02] hover:bg-lime-400/15"
              >
                Win Rewards
              </Link>
              <Link
                href="/store"
                className="inline-flex h-8 items-center gap-1.5 rounded-full bg-[linear-gradient(135deg,#f97316,#fbbf24)] px-4 text-xs font-bold text-stone-950 transition hover:scale-[1.02]"
              >
                🛒 Wipe Store
              </Link>
            </div>
