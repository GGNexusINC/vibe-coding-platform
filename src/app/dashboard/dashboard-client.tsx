        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
          ...
          {!user && (
            <a
              ...
              className="inline-flex h-10 items-center gap-2 rounded-xl bg-orange-500 px-4 text-sm font-bold text-stone-950 hover:bg-orange-400 transition"
            >
        ...
        {user ? (
          ...
          <div className="mb-8 rounded-[2rem] border border-teal-500/20 bg-slate-950/60 overflow-hidden relative">
            ...
            <div className="relative px-7 py-5">
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3" style={{ filter:"blur(3px)", pointerEvents:"none", userSelect:"none", opacity:0.4 }}>
                {[
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="flex flex-col items-center gap-2 rounded-2xl border border-white/10 bg-slate-950/90 px-8 py-5 backdrop-blur-sm text-center">
                  ...
                  <div className="text-xs text-slate-400 max-w-xs">Pack history, active perks, and wipe items — all tracked after sign in.</div>
                  <a
                    href="/auth/discord/start?next=/dashboard"
